<template>
  ...
  >
    <rect width="32" height="32" rx="1" ry="1" stroke-width="0" />
    <rect
      id="e5ejkX1CmiH3"
      width="13"
      height="13"
    ...
    <rect
      ...
      rx="1"
      ry="1"
      transform="translate(17 17.000011)"
      fill="#4481c3"
      stroke-width="0"
    />
  </svg>
...
onMounted(() => {
  !(function (t, n) {
    ...
    function It(t, n, e, r, i) {
      ...
      return (
        o ||
          (o = { x: Pt(t.x, n.x, e.x, r.x, i), y: Pt(t.y, n.y, e.y, r.y, i) }),
        u && (o.a = Rt(t, n, e, r, i)),
        o
      );
    }
              ...
              transform: {
                ...
                keys: {
                  o: [
                    {
                      t: 0,
                      v: { x: 8.5, y: 8.5, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    {
                      t: 200,
                      v: { x: 23.5, y: 8.5, type: "corner" },
                      e: [0.42, 0, 0.58, 1],
                    },
                    { t: 500, v: { x: 23.5, y: 8.5, type: "corner" } },
                    {
                      t: 600,
                      v: { x: 23.5, y: 8.5, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 800, v: { x: 23.5, y: 23.499992, type: "corner" } },
                    { t: 1100, v: { x: 23.5, y: 23.499992, type: "corner" } },
                    {
                      t: 1200,
                      v: { x: 23.5, y: 23.499992, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 1400, v: { x: 8.5, y: 23.5, type: "corner" } },
                    { t: 1700, v: { x: 8.5, y: 23.5, type: "corner" } },
                    {
                      t: 1800,
                      v: { x: 8.5, y: 23.5, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 2000, v: { x: 8.5, y: 8.500004, type: "corner" } },
                  ],
                },
              },
            },
              ...
              transform: {
                ...
                keys: {
                  o: [
                    ...
                    { t: 700, v: { x: 8.5, y: 8.5, type: "corner" } },
                    {
                      t: 800,
                      v: { x: 8.5, y: 8.5, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 1000, v: { x: 23.5, y: 8.5, type: "corner" } },
                    { t: 1300, v: { x: 23.5, y: 8.5, type: "corner" } },
                    {
                      t: 1400,
                      v: { x: 23.5, y: 8.5, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 1600, v: { x: 23.5, y: 23.5, type: "corner" } },
                    { t: 1900, v: { x: 23.5, y: 23.5, type: "corner" } },
                    {
                      t: 2000,
                      v: { x: 23.5, y: 23.5, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 2200, v: { x: 8.5, y: 23.5, type: "corner" } },
                  ],
                },
              },
            },
              ...
              transform: {
                ...
                keys: {
                  o: [
                    {
                      t: 400,
                      v: { x: 23.5, y: 23.500011, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 600, v: { x: 8.5, y: 23.499997, type: "corner" } },
                    { t: 900, v: { x: 8.5, y: 23.499997, type: "corner" } },
                    {
                      t: 1000,
                      v: { x: 8.5, y: 23.499997, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 1200, v: { x: 8.5, y: 8.500005, type: "corner" } },
                    { t: 1500, v: { x: 8.5, y: 8.500005, type: "corner" } },
                    {
                      t: 1600,
                      v: { x: 8.5, y: 8.500005, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 1800, v: { x: 23.5, y: 8.500005, type: "corner" } },
                    { t: 2100, v: { x: 23.5, y: 8.500005, type: "corner" } },
                    {
                      t: 2200,
                      v: { x: 23.5, y: 8.500005, type: "corner" },
                      e: [0.075, 0.82, 0.165, 1],
                    },
                    { t: 2400, v: { x: 23.5, y: 23.499997, type: "corner" } },
                  ],
                },
              },
            },
          },
          s: "|",
        },
      ],
      options: "MADAxMDg4UzJmWTgwODYE2ZTdmODEyZjQ3MmZTMNzk3YzZlNzEyZjhhO",
    },
    "__SVGATOR_PLAYER__",
    window
  );
