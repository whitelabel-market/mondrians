<template>
  <section id="Creator" class="bg-reddish text-white mondrian-border-bottom">
    <div
    ...
    >
      <div class="space-y-4">
        ...
        <div class="space-y-2">
          <p class="gs_reveal">
            ...
            more than 100 years of experience in experimenting with art.
          </p>
          <p class="gs_reveal">
      ...
      <img
        ...
        alt="Creator"
        class="gs_reveal gs_reveal_fromLeft md:order-first"
      />
    </div>
  </section>
</template>
