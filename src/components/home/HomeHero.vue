      ...
      >
        ...
        <div class="lgs:ml-8 mt-6 lgs:mt-0 lgs:max-w-[454px]">
          ...
          <div class="flex items-center justify-center w-full mt-4 space-x-4">
            <button class="w-10 h-10 rounded-full bg-yellowish">-</button>
            <input
              readonly
              type="text"
              name="mint"
          ...
          <p
            class="flex items-center justify-center mt-4 space-x-2 text-sm font-semibold"
          >
...
export default defineComponent({
  ...
  //     let phases: any;
  //     onMounted(async () => {
  //       totalSupply.value = await $mondrian.getTotalSupply();
  //     });
  //     const mint = async () => {
  //       try {
  //         switch (phases) {
  //           case "whitelist":
  //             const voucher = await whitelistInterface.getVoucher("abcd");
  //             if (voucher) {
  //               // WL MINT
  //             }
  //           case "public":
  ...
  //       }
  //     };
  //     return { quantity, price, mint, totalSupply };
  //   },
});
</script>
