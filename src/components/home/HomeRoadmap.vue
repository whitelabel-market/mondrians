<template>
  <section
    id="Roadmap"
    class="bg-[rgba(252,218,25,0.45)] mdx:px-4 md:pt-12 md:pb-24 pt-[2.75rem] pb-[2.063rem]"
  >
    <div
      class="md:grid md:grid-cols-2 mdx:flex mdx:flex-col-reverse max-w-[54.875rem] mx-auto"
    >
      <img
      ...
      <div class="md:ml-24 md:mt-16">
        ...
        <div class="bg-white md:p-5 p-[1.125rem] mt-5">
          ...
          <p class="text-sm mt-1.5 opacity-50">
            ...
            ciusmod tempor incididunt ut.Lorem ipsum dolor sit amet, consectetur
