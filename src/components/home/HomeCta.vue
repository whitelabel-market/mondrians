<template>
  <section
    class="bg-[#8DB1D1] md:pt-[4.688rem] pt-[2.5rem] md:pb-[5.188rem] pb-[4.375rem] mdx:pl-[1.938rem] relative overflow-hidden"
  >
        ...
        <div class="items-center mdx:flex">
          ...
          <div class="md:hidden w-[141px] h-[141px] relative">
            <img
              ...
              class="h-full absolute left-[1.5rem] top-0"
              alt=""
            />
            <div
    ...
    <img
      ...
      alt=""
      class="absolute top-0 md:h-full right-20 mdx:hidden"
    />
  </section>
</template>
