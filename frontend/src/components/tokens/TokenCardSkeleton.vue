<template>
  <div
    class="flex flex-col justify-between h-full gap-4 p-4 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg"
  >
    <div
    ...
    <div
      class="flex items-center justify-center w-full aspect-square bg-neutral-200 dark:bg-neutral-700 rounded-lg animate-pulse"
      style="animation-delay: 100ms; animation-fill-mode: backwards"
    ></div>
    <div v-if="!dense" class="flex items-center justify-between">
      <div
