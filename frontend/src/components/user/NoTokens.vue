<template>
  <div
    class="flex flex-col items-center mx-auto space-y-8 text-center transition-colors duration-1000 flex-0 text-neutral-900 dark:text-neutral-200"
    v-if="error || aborted"
  >
  ...
  >
    <div
      class="flex items-center justify-center w-10 h-10 p-2 transition-colors duration-1000 bg-white rounded-full shadow-lg animate-bounce dark:bg-neutral-200 ring-1 ring-slate-900/5 dark:ring-slate-200/20"
    >
