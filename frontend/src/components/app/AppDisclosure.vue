<template>
  <Disclosure
    as="div"
    v-slot="{ open }"
    class="w-full bg-yellow-100 border-4 border-neutral-800 rounded relative after:block after:absolute after:bottom-0 after:right-0 after:-z-10 after:!w-full after:!h-full after:translate-x-1 after:translate-y-1 after:bg-neutral-800 after:rounded"
  >
    <DisclosureButton
