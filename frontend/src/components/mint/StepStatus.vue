<template>
  <div :class="['flex items-center justify-center w-8 h-8']">
    ...
    <span
      v-else
      class="flex items-center justify-center w-8 h-8 font-semibold text-sm text-white duration-100 rounded-full bg-neutral-900 dark:bg-white dark:text-black"
      >{{ index + 1 }}</span
    >
  </div>
</template>
