<template>
  <TransitionRoot appear :show="modelValue" as="template">
    <Dialog as="div">
      ...
      >
        <div
          class="fixed top-0 left-0 flex flex-col w-full h-screen bg-white text-neutral-900 dark:bg-neutral-900 transition-colors duration-1000 pt-20 lg:hidden z-70"
        >
          <div class="flex-1 p-8 space-y-8 overflow-y-auto mondrian-border-b">
            <ul class="flex flex-col gap-6 font-sans font-bold mobile-controls">
              <li
                ...
                :key="to"
                class="text-xl font-bold transition-colors duration-1000 text-neutral-900 dark:text-neutral-200"
              >
                <router-link
            ...
            <div class="flex flex-col gap-4">
              ...
              >
                <div class="z-50 flex items-center w-full gap-4">
                  ...
                  />
                  <span
                    class="text-sm font-black lowercase transition-colors duration-1000 text-neutral-800 dark:text-neutral-200 slashed-zero"
                    >{{ ensAccount?.name || privateAddress }}</span
                  >
                </div>
              </AppButton>
              <div
                class="relative flex items-center justify-between p-4 transition-colors duration-1000 bg-neutral-200 dark:text-neutral-400 bg-opacity-60 text-neutral-600 dark:bg-neutral-800 dark:bg-opacity-80 rounded"
              >
                <span
