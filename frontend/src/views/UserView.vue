  ...
  <div class="">
    ...
    >
      ...
      >
        ...
        >
          <router-link
            class="relative inline-flex items-center justify-center flex-1 px-2 text-xs font-bold text-center uppercase transition-colors duration-1000 ease-in-out -translate-y-1 bg-white border-4 border-b-0 rounded-t md:flex-grow-0 md:flex-auto md:w-32 md:px-4 border-neutral-800 dark:border-black dark:bg-neutral-800 dark:text-neutral-200 text-neutral-900 h-14 hover:-translate-y-2"
    ...
    <section
      class="container justify-center px-8 mx-auto transition-colors duration-1000 bg-white sm:px-4 dark:bg-neutral-900"
    >
