  ...
  <div>
    ...
    <section>
      <div class="container max-w-4xl mx-auto px-8 space-y-8">
        ...
        <div class="space-y-2">
          <h2 class="text-xl font-bold">Datenerfassung auf unserer Website</h2>
          ...
          <p>
            ...
            ("Terms of service") dieser Website entnehmen.
          </p>

          <h3 class="text-sm font-bold">Wie erfassen wir Ihre Daten?</h3>
          <p>
          ...
          <h3 class="text-sm font-bold">Wofür nutzen wir Ihre Daten?</h3>
          <p>
        ...
        <div class="space-y-2">
          ...
          <h2 class="text-xl font-bold">Hinweis zur verantwortlichen Stelle</h2>
          <div>
            <p>
            ...
            <ul>
              <li>NXT YOU GmbH</li>
              <li>Tölzer Straße 1</li>
              <li>82031 Grünwald</li>
              <li>Telefon: +49 176 5684 2497</li>
              <li>E-Mail: info@nxtyou.de</li>
            </ul>
            <p>
          ...
          <h2 class="text-xl font-bold">Recht auf Datenübertragbarkeit</h2>
          <p>
          ...
          <h2 class="text-xl font-bold">SSL- bzw. TLS-Verschlüsselung</h2>
          <p>
        ...
        <div class="space-y-2">
          ...
          <p>
            ...
            Nutzung dieses Analyse-Tools erfolgen auf Grundlage von Art. 6 Abs.
          ...
          <h3 class="text-sm font-bold">IP Anonymisierung</h3>
          <p>
          ...
          <h3 class="text-sm font-bold">Browser Plugin</h3>
          <p>
          ...
          <h3 class="text-sm font-bold">Widerspruch gegen Datenerfassung</h3>
          <p>
          ...
          <h3 class="text-sm font-bold">Auftragsverarbeitung</h3>
          <p>
          ...
          <h3 class="text-sm font-bold">Speicherdauer</h3>
          <p>
        ...
        <div class="space-y-2">
          ...
          <p>
            ...
            Barrow Street, Dublin 4, Irland. Wir nutzen YouTube im erweiterten
            Datenschutzmodus. Dieser Modus bewirkt laut YouTube, dass YouTube
            keine Informationen über die Besucher auf dieser Website speichert,
            bevor diese sich das Video ansehen. Die Weitergabe von Daten an
            YouTube-Partner wird durch den erweiterten Datenschutzmodus hingegen
            nicht zwingend ausgeschlossen. So stellt YouTube – unabhängig davon,
            ob Sie sich ein Video ansehen – eine Verbindung zum Google
            DoubleClick-Netzwerk her. Sobald Sie ein YouTube-Video auf unserer
            ...
            indem Sie sich aus Ihrem YouTube-Account ausloggen. Des Weiteren
            kann YouTube nach Starten eines Videos verschiedene Cookies auf
            ...
            Endgerät, bis Sie sie löschen. Gegebenenfalls können nach dem Start
            eines YouTube-Videos weitere Datenverarbeitungsvorgänge ausgelöst
            werden, auf die wir keinen Einfluss haben. Die Nutzung von YouTube
            ...
            Art. 6 Abs. 1 lit. f DSGVO dar. Weitere Informationen über
            Datenschutz bei YouTube finden Sie in deren Datenschutzerklärung
            unter: https://policies.google.com/privacy?hl=de.
          </p>

          <h2 class="text-xl font-bold">Google Web Fonts</h2>
          <p>
